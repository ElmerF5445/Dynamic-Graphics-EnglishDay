...
/* Navigation List */
let Startup_NavigationList_Array_Titles = ["Control Panel", "Buzzer 1", "Buzzer 2"]; //Launcher navigation text
let Startup_NavigationList_Array_Links = ["GG_Controls.html", "GG_Buzzer_1.html", "GG_Buzzer_2.html"]; //Launcher navigation links
let Startup_NavigationList_Array_Icons = ["favicon_old.png", "favicon_old.png", "favicon_old.png"];
...
function Startup_Load_Properties(){
    ...
    switch(App_CurrentPageName){
		...
		case "GG_Controls.html":
			...
			pageProperty_enableFullContainerMode = 0;
        break;
		case "GG_Buzzer_1.html":
            pageProperty_pageIcon = "ContentByElmerF.png";
            pageProperty_MenuName = "Buzzer 1";
            pageProperty_PageTitle = "Buzzer 1";
            pageProperty_enableGreetings = 0;
			...
			pageProperty_enableFullContainerMode = 0;
        break;
		case "GG_Buzzer_2.html":
            pageProperty_pageIcon = "ContentByElmerF.png";
            pageProperty_MenuName = "Buzzer 2";
            pageProperty_PageTitle = "Buzzer 2";
            pageProperty_enableGreetings = 0;
            pageProperty_enableSidebar = 0;
            pageProperty_enableCategoryLabelIcons = 0;
            pageProperty_lockSidebar = 1;
